...
class Dormint:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Dormint Script by {Fore.BLUE + Style.BRIGHT}HACKER WORLD BD
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}Join my channel:- {Fore.YELLOW + Style.BRIGHT}https://t.me/HACKER_WORLD_BD
            """
        )
